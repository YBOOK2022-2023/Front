...
const likedPost=useRef<Post[]>([]);
    ...
    const { isSuccess: profileQuerySuccess, isError: profileQueryError, isLoading: profileQueryLoading, data: profileData } =
    ...
    if (profileQueryError) {return (<div>...Errror....</div>)}
