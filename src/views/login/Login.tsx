...
export function LoginForm(props: any) {
  const { switchToRegister, switchToForgotPassword } =
    useContext(AccountContext);
  const {
    register,
    handleSubmit,
    formState: { errors },
  } = useForm<MyFieldsLogin>({
  ...
  return (
    <BoxContainer>
      <FormContainer onSubmit={handleSubmit(onSubmit)}>
        ...
        <BoldLink className='my-2' href='#' onClick={switchToForgotPassword}>
          Mot de passe oublié?
        </BoldLink>
      ...
      <MutedLink className='my-2'>Pas de compte ?</MutedLink>
