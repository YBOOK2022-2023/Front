...
function InfoBar(props: { userName: string; numfriends?: number;showButton:boolean }) {
  ...
  const { userName,numfriends,showButton} = props;
    ...
    {showButton && (<Button onClick={navigateToFriends} variant="contained" color="primary" size="small" sx={{marginTop: "0.5rem"}}> Friends</Button>)}
    </div>
